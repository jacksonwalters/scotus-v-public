...
cd_df=pd.read_csv('~/data/scdb_case_data.csv',encoding='windows-1252')
...
jd_df=pd.read_csv('~/data/scdb_justice_data.csv',encoding='windows-1252')
...
po_df=pd.read_csv('~/data/anes_data.csv')
